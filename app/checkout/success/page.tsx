      ...
      <Card className="mx-auto max-w-2xl">
        <CardContent className="flex flex-col items-center gap-6 p-12 text-center">
          ...
          <p className="text-balance text-sm text-muted-foreground">
            {locale === "uk"
              ? "Ми надіслали підтвердження на вашу електронну пошту. Наш менеджер зв'яжеться з вами найближчим часом для підтвердження деталей замовлення."
              : "We have sent a confirmation to your email. Our manager will contact you shortly to confirm your order details."}
          </p>
